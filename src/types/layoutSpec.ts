 ...
 * - [Rule 1.3] Space keyframe controls live on the 2D Atlas Viewer Y axis.
 * - [Rule 1.4] Color channel filters are local to the curve editor controls.
 * - [Rule 1.5] The status bar belongs to the 2D Atlas Viewer and forms the
 * bottom boundary of that representation, not a global page footer.
 *
